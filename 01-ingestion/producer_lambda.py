...
def lambda_handler(event, context):
            ...
            <html>
                <head>
                    ...
                    <style>
                        ...
                        /* Estilos añadidos para el formulario sin romper lo anterior */
                ...
                <body>
                    ...
                    <script>
                        document.getElementById('notifForm').addEventListener('submit', async (e) => {
                            ...
                            try {
                                // Enviamos la petición POST a la ruta /send (o a la raíz si no usaste /send)
                                // Si tu API usa /send, mantenlo así. Si usa la raíz, cambia '/send' por './'
    ...
    # 2. SI ES POST, PROCESAMOS LA NOTIFICACIÓN (Lógica original intacta)
